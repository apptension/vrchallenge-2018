Cartoon FX Pack 3, version 1.2.03
2017/10/26
© 2017 - Jean Moreno
=================================
...
1.2 (Unity 5.6+)
- 20+ new effects:
	* Electric/CFX3_Hit_Electric_(B/C)_(Air/Ground)
	* Fire/CFX3_Fireball_B
	* Fire/CFX3_Fire_Explosion
	* Fire/CFX3_Fire_Shield
	* Fire/CFX3_Flying_Ember_Disrupted_Upward
	* Ice/CFX3_Ice_Shield
	* Ice/CFX3_IceBall_B
	* Magic Dark/CFX3_Dark_Sun
	* Magic Dark/CFX3_Beetles
	* Magic Misc/CFX3_Magic_Fountain
	* Magic Misc/CFX3_Vortex_(Air/Ground)_Outward
	* Misc/CFX3_Suspicious_Cloud_(White/Black)
	* Misc/CFX3_Broken_Machine_Clouds_(White/Black)
	* Misc/CFX3_Skull_Explosion (Direct)
- updated the demo scene with some of the new effects
- all effects can now be scaled using the Transform component (CartoonFX Easy Editor still recommended for proper scaling though!)
...
- improved falling leaves animation

1.19.21
- Cartoon FX Easy Editor bugfix

1.19.2
- removed unused script that was giving warnings in Unity 5.5
